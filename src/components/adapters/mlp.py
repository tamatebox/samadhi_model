...
from src.configs.adapters import MlpAdapterConfig  # Changed import path
from src.configs.factory import create_adapter_config  # Added for dict support if needed
