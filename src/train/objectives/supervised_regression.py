...
class SupervisedRegressionObjective(BaseObjective):
    """
    Supervised regression objective for Samadhi Model, typically using MSE for reconstruction.
    Incorporates reconstruction, stability, entropy, and load balancing losses.
    """
    ...
    def compute_loss(
        ...
        if y is None:
            raise ValueError("Target 'y' cannot be None for SupervisedRegressionObjective.")
